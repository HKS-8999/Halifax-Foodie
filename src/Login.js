const Login = () => {
  return (
    <>
      ...
      <ul>
        <li>
          <a href="https://resto-owner-app.auth.ap-south-1.amazoncognito.com/login?client_id=4ppsva9chdc6i0f2hr6641ji90&response_type=token&scope=email+openid+profile&redirect_uri=http://localhost:3000/auth-question">
            Owner
          </a>
        </li>
        <li>
